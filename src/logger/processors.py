...
def add_trace_span_id(_: logging.Logger, __: str, event_dict: EventDict) -> EventDict:
    current_span = get_current_span()
    trace_id = current_span.get_span_context().trace_id if current_span else INVALID_TRACE_ID
    span_id = current_span.get_span_context().span_id if current_span else INVALID_SPAN_ID
